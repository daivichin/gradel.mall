...
import com.gradel.api.user.domain.service.search.example.entity.DemoSearchResult;
...
public class MultiESRestClientTest extends BaseSpringTest {
    private Logger logger = LoggerFactory.getLogger(MultiESRestClientTest.class);
    @Autowired

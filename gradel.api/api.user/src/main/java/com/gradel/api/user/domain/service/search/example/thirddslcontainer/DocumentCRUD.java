...
import com.gradel.api.user.domain.service.search.example.entity.*;
...
public class DocumentCRUD {
    ...
    public void testBulkAddDocumentsWithESIndex() {
        ...
        String response = clientInterface.addDocuments(
                //为了测试效果,启用强制刷新机制，实际线上环境去掉最后一个参数"refresh=true"
                demos, clientOptions);

package com.gradel.api.user.domain.service.search.example.curd;

import com.gradel.api.user.domain.service.search.example.entity.Demo;
import com.gradel.api.user.domain.service.search.example.entity.DemoWithESIndex;
import com.gradel.api.user.domain.service.search.example.entity.FieldDemo;
import com.gradel.api.user.domain.service.search.example.entity.NewDemo;
...
public class DocumentCRUD {
    ...
    public void testBulkAddDocumentsWithESIndex() {
        ...
        ClientInterface clientUtil = bbossESStarter.getConfigRestClient("esmapper/scroll.xml");
        ...
        String datasr = bbossESStarter.getRestClient().executeHttp("demowithesindex-*/_search", "{\"size\":1000,\"query\": {\"match_all\": {}}}", ClientInterface.HTTP_POST);
...
//				.setEsRetryOnConflict(2)
    ...
    public void testBulkAddDocuments() {
        ...
        System.out.println("BulkAdd 20002 Documents elapsed:" + (end - start) + "毫秒");
        start = System.currentTimeMillis();
        String datasr = bbossESStarter.getRestClient().executeHttp("demo/_search", "{\"size\":1000,\"query\": {\"match_all\": {}}}", ClientInterface.HTTP_POST);
        System.out.println(datasr);
        //scroll查询2万条记录：0.6s，参考文档：https://my.oschina.net/bboss/blog/1942562
...
//		String json = com.frameworkset.util.SimpleStringUtil.object2json(demos);
    ...
    public void testTerm() {
        ...
        ClientInterface clientUtil = bbossESStarter.getConfigRestClient("esmapper/orderQuery.xml");
